...
<div class="main_content">
    ...
    <div class="windows container">
        ...
        <div class="windows_right">
            <h4>Windows</h4>
            <p>The right windows can make your home – helping frame your home’s overall look and determine your
                level of energy efficiency. Our no-obligation damage inspection will determine if your windows are
                damaged or leaky and in need of replacement.</p>

            <p>Our team of professionals handles and installs quality products from America’s most trusted window
                and glass companies, such as Simonton Windows. Offering a lifetime manufacturer’s warranty, Simonton
                Windows are available in a variety of styles and sizes, and are made from the highest quality
                materials available today, including Low Emissivity (Low E) and Argon gas.</p>

            <p>Whether you choose windows that are wood or vinyl, single or double hung, our Storm Guard team will
                install your new or replacement windows right the first time. You can always count on quality
                construction, premium aesthetics, and energy efficiency, all with the finish options and hardware
