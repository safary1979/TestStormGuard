...
function register_styles()
{
    ...
    wp_register_style('ekko_lightbox-css', get_template_directory_uri() . '/assets/css/ekko-lightbox.css');
    wp_enqueue_style('ekko_lightbox-css');
...
function register_scripts()
{
    ...
    wp_register_script('jquery-js', get_template_directory_uri() . '/assets/js/jquery-3.3.1.min.js ');
    ...
    wp_register_script('ekko_lightbox-js', get_template_directory_uri() . '/assets/js/ekko-lightbox.js ');
    wp_enqueue_script('ekko_lightbox-js');

    if ( is_front_page() || is_home() ) {
        wp_deregister_script( 'jquery-migrate' );
        wp_register_script('jquery-migrate', get_template_directory_uri() . '/assets/js/jquery-migrate-3.0.1.min.js ');
        wp_enqueue_script('jquery-migrate');

        wp_register_script('slick-js', get_template_directory_uri() . '/assets/slick/slick.min.js');
...
register_nav_menus( array(
    ...
    'header_bottom_menu' => 'header bottom menu',
...
if ( function_exists( 'add_image_size' ) ) {
    add_image_size('gallery_footer', 129, 129, true);
    add_image_size('service_content', 535, 9999 );
    add_image_size('gallery_archive', 280, 9999 );
}
